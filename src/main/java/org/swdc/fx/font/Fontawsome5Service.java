...
public class Fontawsome5Service {
    ...
    private Map<FontSize, Font> fontsFreeRegular = new HashMap<>();
    private Map<FontSize, Font> fontsSolid = new HashMap<>();
    private Map<FontSize, Font> fontsBrand = new HashMap<>();
    ...
    public Fontawsome5Service() {
        try {
            ...
            fontsFreeRegular.put(FontSize.LARGE, Font.loadFont(module.getResourceAsStream(location[1]),64));
            fontsFreeRegular.put(FontSize.MIDDLE_LARGE, Font.loadFont(module.getResourceAsStream(location[1]),32));
            fontsFreeRegular.put(FontSize.MIDDLE, Font.loadFont(module.getResourceAsStream(location[1]),24));
            fontsFreeRegular.put(FontSize.MIDDLE_SMALL, Font.loadFont(module.getResourceAsStream(location[1]),18));
            fontsFreeRegular.put(FontSize.SMALL, Font.loadFont(module.getResourceAsStream(location[1]),16));
            fontsFreeRegular.put(FontSize.VERY_SMALL, Font.loadFont(module.getResourceAsStream(location[1]),14));
            fontsFreeRegular.put(FontSize.SMALLEST,Font.loadFont(module.getResourceAsStream(location[1]),12));


            fontsSolid.put(FontSize.LARGE, Font.loadFont(module.getResourceAsStream(location[0]),64));
            fontsSolid.put(FontSize.MIDDLE_LARGE, Font.loadFont(module.getResourceAsStream(location[0]),32));
            fontsSolid.put(FontSize.MIDDLE, Font.loadFont(module.getResourceAsStream(location[0]),24));
            fontsSolid.put(FontSize.MIDDLE_SMALL, Font.loadFont(module.getResourceAsStream(location[0]),18));
            fontsSolid.put(FontSize.SMALL, Font.loadFont(module.getResourceAsStream(location[0]),16));
            fontsSolid.put(FontSize.VERY_SMALL, Font.loadFont(module.getResourceAsStream(location[0]),14));
            fontsSolid.put(FontSize.SMALLEST,Font.loadFont(module.getResourceAsStream(location[0]),12));

            fontsBrand.put(FontSize.LARGE, Font.loadFont(module.getResourceAsStream(location[2]),64));
            fontsBrand.put(FontSize.MIDDLE_LARGE, Font.loadFont(module.getResourceAsStream(location[2]),32));
            fontsBrand.put(FontSize.MIDDLE, Font.loadFont(module.getResourceAsStream(location[2]),24));
            fontsBrand.put(FontSize.MIDDLE_SMALL, Font.loadFont(module.getResourceAsStream(location[2]),18));
            fontsBrand.put(FontSize.SMALL, Font.loadFont(module.getResourceAsStream(location[2]),16));
            fontsBrand.put(FontSize.VERY_SMALL, Font.loadFont(module.getResourceAsStream(location[2]),14));
            fontsBrand.put(FontSize.SMALLEST,Font.loadFont(module.getResourceAsStream(location[2]),12));
    ...
    public Font getRegularFont(FontSize size) {
        return fontsFreeRegular.get(size);
    }

    public Font getBrandFont(FontSize size) {
        return fontsBrand.get(size);
    }

    public Font getSolidFont(FontSize size) {
